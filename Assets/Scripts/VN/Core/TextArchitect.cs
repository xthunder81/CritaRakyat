...
public class TextArchitect
{
    ...
    private IEnumerator Build_TypeWriter()
    {
        ...
        {
            tmpro.maxVisibleCharacters += increaseSpeed ? characterPerCycle * 5 : characterPerCycle;
    ...
    private IEnumerator Build_Fade()
    {
        ...
        while (true)
        {
            float fadeSpeed = ((increaseSpeed ? characterPerCycle * 5 : characterPerCycle) * speed) * 4f;
