...
public class DLAudioManager : MonoBehaviour {
    
    public static DLAudioManager instance;
	...
	public class SONG
	{
		...
		{
			source = DLAudioManager.CreateNewSource(string.Format("SONG [{0}]", clip.name));
			source.clip = clip;
			...
			DLAudioManager.allSongs.Add(this);
		...
		{
			DLAudioManager.allSongs.Remove(this);
